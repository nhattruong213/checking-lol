...
export async function GET(request: NextRequest) {
  ...
  const tags = `${gameNameSearch}#`;

  try {
    const accountList = await fetch(`https://lol-web-api.op.gg/api/v1.0/internal/bypass/summoners/v2/vn/autocomplete?gameName=${gameNameSearch}`, {
